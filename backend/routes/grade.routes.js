...
import { getGrades, getGradesByStudentAndPeriod, createOrUpdateGrade, createOrUpdateGradesBatch, calculateFinalAverage, getStudentReport } from '../controllers/grade.controller.js';
...
router.post('/batch', authenticate, authorize('director', 'profesor'), createOrUpdateGradesBatch);
